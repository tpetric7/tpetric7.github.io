...
Fast 7,5% der als Adjektiv identifizierten Lemmas im Roman "prozess" enden mit dem Suffix "-lich", im Roman "tom" sind es weniger als 4%. Der Unterschied ist auch in der graphischen Darstellung zu sehen.
...
Das Suffix "-lich" gehört zu den produktiven Wortbildungsmitteln im Deutschen. Warum sind im "prozess" mehr davon zu finden als im anderen Roman? Um diese Frage (zumindest ansatzweise) klären zu können, schauen wir eine Liste der Adjektive in den Romanen an.
