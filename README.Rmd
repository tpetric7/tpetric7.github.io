...
```{r}
polite <- read.csv("data/politeness_data.csv")
...
Convert R to Rmd: [Ctrl + Shift + K] or [knitr::spin("t_preskus.R")]
Cf. https://bookdown.org/yihui/rmarkdown-cookbook/spin.html
