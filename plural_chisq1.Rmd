...
Podatkovni niz preoblikujemo in povzemamo (aggregiramo). 
...
Če je p-vrednost < 0,05 (tj. 5%), potem V tem primeru obvelja H1. Razlika med opazovanimi in pričakovanimi pogostnostmi je statistično značilna (tj. da ni naključna). 
