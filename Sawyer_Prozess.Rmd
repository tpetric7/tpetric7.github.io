...
Besedilno-besedna matrika (dfm) je izhodišče za izračun pogostnosti besednih oblik v posameznih besedilih:
...
```{r}
(coll_2 = textstat_collocations(woerter, size = 2, tolower = TRUE)
)
